...
if __name__ == "__main__":
    ...
    print('Posterior Mean: ' + str(infer_parameters_pmcabc().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_abcsubsim().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_rsmcabc().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_sabc().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_smcabc().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_apmcabc().posterior_mean()))
    print('Posterior Mean: ' + str(infer_parameters_rejectionabc().posterior_mean()))
