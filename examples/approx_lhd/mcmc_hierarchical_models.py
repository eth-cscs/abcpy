...
def infer_parameters(n_samples=500, burnin=250, n_samples_per_param=40, logging_level=logging.WARN):
    """Perform inference for this example.

    Parameters
    ----------
    n_samples : integer, optional
        Number of posterior samples to generate. The default value is 500.
    burnin : integer, optional
        Number of burnin steps for the MCMC. The default value is 250.
    ...
    from abcpy.inferences import MCMCMetropoliHastings
    sampler = MCMCMetropoliHastings([final_grade, final_scholarship],
                                    [approx_lhd_final_grade, approx_lhd_final_scholarship], backend, kernel, seed=1)

    # Sample
    journal = sampler.sample([grades_obs, scholarship_obs], n_samples=n_samples, burnin=burnin,
