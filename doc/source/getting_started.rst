...
Notice that we gave a parameter *name* to the prior. You are required to pass such a string to any parameter that is part of the prior. In the final output, you will see these names, together with the values that were infered for this parameter.
